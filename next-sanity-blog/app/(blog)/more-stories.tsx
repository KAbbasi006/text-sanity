...
export default async function MoreStories(params: {
  ...
  return (
    <>
      <div id="blg" className=" mb-32 grid grid-cols-1 gap-y-20 md:grid-cols-2 md:gap-x-16 md:gap-y-32 lg:gap-x-32">
        {data?.map((post) => {
          const { _id, title, slug, coverImage, excerpt, author } = post;
          return (
            <article className="shadow-md bg-white p-5" key={_id}>
